        ...
        7: [function(a, b, c) {
            var d = a("./path"),
                ...
                g = function a(b, c) {
                    ...
                    if (0 !== arguments.length) {
                        this._opts = e.extend({ color: "var(--cor1)", strokeWidth: 1, trailColor: null, trailWidth: null, fill: null, text: { style: { color: null, position: "absolute", left: "50%", top: "50%", padding: 0, margin: 0, transform: { prefix: !0, value: "translate(-50%, -50%)" } }, autoStyleContainer: !0, alignToBottom: !0, value: null, className: "progressbar-text" }, svgStyle: { display: "block", width: "400px" }, warnings: !1 }, c, !0), e.isObject(c) && void 0 !== c.svgStyle && (this._opts.svgStyle = c.svgStyle), e.isObject(c) && e.isObject(c.text) && void 0 !== c.text.style && (this._opts.text.style = c.text.style);
            ...
            g.prototype.animate = function(a, b, c) {
                ...
                var b = this._trailString(a),
                    c = e.extend({}, a);
                return c.trailColor || (c.trailColor = "#EA99D5"), c.trailWidth || (c.trailWidth = c.strokeWidth), c.color = c.trailColor, c.strokeWidth = c.trailWidth, c.fill = null, this._createPathElement(b, c)
